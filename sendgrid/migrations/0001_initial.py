...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('sendgrid_emailmessagesubjectdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='subject', unique=True,
                                                                      primary_key=True,
        ...
        db.create_table('sendgrid_emailmessagesendgridheadersdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='sendgrid_headers', unique=True,
                                                                      primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table('sendgrid_emailmessageextraheadersdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='extra_headers', unique=True,
                                                                      primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table('sendgrid_emailmessagebodydata', (
            ('email_message', self.gf('django.db.models.fields.related.OneToOneField')(related_name='body', unique=True,
                                                                                       primary_key=True, to=orm[
        ...
        db.create_table('sendgrid_emailmessageattachmentsdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='attachments', unique=True,
                                                                      primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table('sendgrid_emailmessagebccdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='bcc', unique=True, primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table('sendgrid_emailmessageccdata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='cc', unique=True, primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table('sendgrid_emailmessagetodata', (
            ('email_message',
             self.gf('django.db.models.fields.related.OneToOneField')(related_name='to', unique=True, primary_key=True,
                                                                      to=orm['sendgrid.EmailMessage'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
